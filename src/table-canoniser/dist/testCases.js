...
const example1_spec = {
    match: {
        ...
        constraints: [{ offsetX: 0, offsetY: 0, valueCstr: grammar_1.TableCanoniserKeyWords.Number }],
        ...
        constraints: [
            {
                offsetX: 0,
                offsetY: 0,
                valueCstr: grammar_1.TableCanoniserKeyWords.Number,
            },
        ],
        traverse: {
            yDirection: "after",
            ...
            match: {
                ...
                constraints: [
                    ...
                    },
                    {
                        offsetX: 0,
                        offsetY: -1,
                        valueCstr: grammar_1.TableCanoniserKeyWords.String,
                    },
                ],
                traverse: {
                    xDirection: "after",
...
const case2_3_spec = {
    match: {
        ...
        constraints: [
            {
                offsetFrom: "topRight",
                valueCstr: grammar_1.TableCanoniserKeyWords.None
            }
        ]
    },
    children: [
            ...
            extract: {
                byContext: {
                    ...
                    toTargetCol: (ctxCells) => {
                        if (ctxCells[0].value === "Announced Date")
                            return "Release Date";
                        ...
                        byContext: {
                            ...
                            toTargetCol: (ctxCells) => {
                                ...
                                if (typeof contextValue != "string")
                                    return null;
                                if (["Height", "H"].includes(contextValue))
                                    return "Height";
                                if (["Width", "W"].includes(contextValue))
                                    return "Width";
                                if (["Depth", "D"].includes(contextValue))
                                    return "Depth";
                                return null;
                            },
                        },
        ...
        },
        {
            ...
            extract: {
                byValue: (currentAreaTbl) => {
                    ...
                    return grammar_1.TableCanoniserKeyWords.pairSort(currentAreaTbl[0].map(Number), ["Front Camera", "Rear Camera"], "asc");
                },
            },
        },
    ],
...
const case5_spec = {
    ...
    fill: grammar_1.TableCanoniserKeyWords.Forward,
    children: [
        {
            match: {
                startCell: {
...
const { rootArea, tidyData } = (0, index_1.transformTable)(case5_mt, [case5_spec]);
