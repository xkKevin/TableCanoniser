<template>
  <!-- <div class="divider-v" @mousedown="startDragV"></div> -->
  <!-- <div class="divider-h" @mousedown="startDragH"></div> -->
  <div class="container">
    <div style="flex: 1; display: flex; flex-direction: column;">
      <div style="flex: 1; display: flex;">
        <div style="flex: 1; background-color: aqua;"></div>
        <div class="divider-v" @mousemove="" @mousedown="getNeighborEls($event, 'width')" @mouseup=""></div>
        <div style="flex: 1; background-color: lightgoldenrodyellow;"></div>
      </div>
      <div class="divider-h" @mousemove="" @mousedown="getNeighborEls($event, 'height')" @mouseup=""></div>
      <div style="flex: 1; background-color: lightgreen;"></div>
    </div>
    <div class="divider-v" @mousemove="" @mousedown="getNeighborEls($event, 'width')" @mouseup=""></div>
    <div style="flex: 1; display: flex; flex-direction: row; background-color: lightcoral;">
